...
<div id="login-div" class="container" ng-app="loginApp" ng-controller="loginController">
<div class="row">
...
<div class="col-md-10">
	<spring:form name="loginForm" method="post" modelAttribute="user">
	<br><br>
    ...
    <span ng-show="loginForm.email.$touched && loginForm.email.$error.required" style="color:red">Email can not be empty!!</span>
    <span ng-show="loginForm.email.$dirty && loginForm.email.$error.pattern" style="color:red">Invalid Email !!</span>
	<br>
	<div class="input-group">
    ...
    <span ng-show="loginForm.password.$touched && loginForm.password.$error.required" style="color:red">Password can not be empty!!</span>
	<br>
...
<br><center><span style="color:red">${requestScope.msg_u}</span></center>
</body>
</html>
...
<script tpe="text/javascript" src="js/login_err.js"></script>
